...
class Trainer():
    ...
    def test(self):
        ...
        #         count += total_params
        # if count!=0:
        #     # IKS_rate: RCANG10R20-0.9717 RCANG5R10-0.9211 EDSR-0.8897, now IKSSparsity for all
        ...
        # # todo dml added: calc param
        # totparam=0
        # layer=0
        # for name, param in self.model.named_parameters():
        #     if 'Threshold' not in name:
        #         totparam+=param.numel()
        # print('RCAN\ttotparam:{}'.format(totparam))
        #
        # IKSremainparam = 0
        # IKStotparam = 0
        # IKSlayer = 0
        ...
        #         IKSremainparam += int(((100 - sparsity[0]) / 100) * sparsity[1])
        #         IKStotparam += sparsity[1]
        #         IKSlayer += 1
        # if IKSlayer!=0:
        #     print('IKS')
        #     print('IKSlayer:{}\tIKStotparam:{}\tIKSremainparam:{}'.format(IKSlayer,IKStotparam,IKSremainparam))
        #     print('IKS_sparsity:{:.4f}%\nGlobal_sparsity:{:.4f}%'.format((1-IKSremainparam/IKStotparam)*100,100*(IKStotparam-IKSremainparam)/totparam))
