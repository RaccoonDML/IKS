...
def conv_layer(in_channels, out_channels, kernel_size, stride=1, dilation=1, groups=1, bias=True):
    ...
    return nn.Conv2d(in_channels, out_channels, kernel_size, stride, padding=padding, bias=bias, dilation=dilation,
                     groups=groups)
#  todo 4:
def conv_layer_iks(in_channels, out_channels, kernel_size, stride=1, dilation=1, groups=1, bias=True):
    padding = int((kernel_size - 1) / 2) * dilation
    return IKSConv(in_channels, out_channels, kernel_size, stride, padding=padding, bias=bias, dilation=dilation,
                     groups=groups)
...
class IMDModule(nn.Module):
    def __init__(self, in_channels, distillation_rate=0.25):
        ...
        # todo 5
        self.c1 = conv_layer_iks(in_channels, in_channels, 3)
        self.c2 = conv_layer_iks(self.remaining_channels, in_channels, 3)
        self.c3 = conv_layer_iks(self.remaining_channels, in_channels, 3)
        self.c4 = conv_layer_iks(self.remaining_channels, self.distilled_channels, 3)
