...
class PAConv(nn.Module):
    ...
    def __init__(self, nf, k_size=3):
        ...
        self.sigmoid = nn.Sigmoid()
        ### todo: add IKS1: in two 3*3 conv in PAConv module
        self.k3 = IKSConv(nf, nf, kernel_size=k_size, padding=(k_size - 1) // 2, bias=False) # 3x3 convolution
        self.k4 = IKSConv(nf, nf, kernel_size=k_size, padding=(k_size - 1) // 2, bias=False) # 3x3 convolution
...
class SCPA(nn.Module):
    ...
    def __init__(self, nf, reduction=2, stride=1, dilation=1):
        ...
        ### todo: add IKS2: in one 3*3 conv in SCPA module, channel A
